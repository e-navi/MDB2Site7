...
namespace Site7DbEditor
{
    public class FormIkouNameColorSettings : Form
    {
        ...
        public FormIkouNameColorSettings(EditorDbManager? db)
        ...
        private void InitializeComponent()
        {
            ...
            // List action buttons (文字が見切れない適切な幅)
            ...
            // Right edit group (レイヤ設定と同じ表示色指定)
        ...
        private void CBoxColor_DrawItem(object? sender, DrawItemEventArgs e)
        {
            ...
            Color c = EditorLayerService.PaletteColors[Math.Clamp(e.Index, 0, 15)];
