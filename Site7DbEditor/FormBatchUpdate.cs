...
namespace Site7DbEditor
{
    public class FormBatchUpdate : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            var lblTable = new Label { Text = "対象テーブル:", Location = new Point(10, 12), AutoSize = true, ForeColor = Color.White, Font = new Font("Yu Gothic UI", 8.5F, FontStyle.Bold) };
            cmbBatchTable = new ComboBox { Location = new Point(90, 8), Size = new Size(150, 23), DropDownStyle = ComboBoxStyle.DropDownList, BackColor = Color.FromArgb(255, 255, 190), ForeColor = Color.Black };

            var lblFilter = new Label { Text = "条件設定:", Location = new Point(10, 42), AutoSize = true, ForeColor = Color.White, Font = new Font("Yu Gothic UI", 8.5F, FontStyle.Bold) };
            cmbBatchFilterCol = new ComboBox { Location = new Point(90, 38), Size = new Size(110, 23), DropDownStyle = ComboBoxStyle.DropDownList, BackColor = Color.FromArgb(43, 45, 66), ForeColor = Color.White };
            cmbBatchFilterOp = new ComboBox { Location = new Point(205, 38), Size = new Size(135, 23), DropDownStyle = ComboBoxStyle.DropDownList, BackColor = Color.FromArgb(43, 45, 66), ForeColor = Color.White };
            txtBatchFilterVal = new TextBox { Location = new Point(345, 38), Size = new Size(140, 23), BackColor = Color.FromArgb(43, 45, 66), ForeColor = Color.White };

            var lblUpdate = new Label { Text = "更新内容:", Location = new Point(10, 72), AutoSize = true, ForeColor = Color.White, Font = new Font("Yu Gothic UI", 8.5F, FontStyle.Bold) };
            cmbBatchUpdateCol = new ComboBox { Location = new Point(90, 68), Size = new Size(110, 23), DropDownStyle = ComboBoxStyle.DropDownList, BackColor = Color.FromArgb(43, 45, 66), ForeColor = Color.White };
            txtBatchUpdateVal = new TextBox { Location = new Point(205, 68), Size = new Size(180, 23), BackColor = Color.FromArgb(255, 255, 190), ForeColor = Color.Black };
            ...
            btnClose = new Button
            {
                ...
                BackColor = Color.FromArgb(53, 55, 76),
                FlatStyle = FlatStyle.Flat,
